"""
main.py
Daulat Mantra — daily Hindi mindset/money Shorts orchestrator.
"""
...
def main():
    print(f"\n{'='*60}")
    print(f"Daulat Mantra Bot  —  {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"{'='*60}\n")
    ...
    # 2. Generate Hindi script + meta
    print("\n[2/6] Generating Hindi script with Groq...")
    ...
    # 4. Cinematic imagery
    print("\n[4/6] Generating cinematic imagery...")
    ...
    build_video(image_paths, audio_path, output_path)
